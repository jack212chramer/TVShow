...
<div class="container">
    <div class="row">
        <div class="col-sm-12 sortBySelector">
        	<h3>Sort by: </h3>
        	<a href="?sortBy=0">Popularity</a>
        	<a href="?sortBy=1">Rating</a>
        	<a href="?sortBy=2">Name</a>
        	<a href="?sortBy=3">Language</a>
        	<a href="?sortBy=4">Number of episodes</a>
        	<a href="?sortBy=5">Number of seasons</a>
        </div>
        <div class="col-sm-10">
...
<a class="sortBySelectorHref" href="serial?tmdb_id=${innerList.getTmdb_id()}">
    <div class="row results_new_cont">
        ...
        <div class="col-sm-12 col-md-10">
        	<div class="results_details_big_new"><h3><c:out value="${innerList.getName()}" /></h3><p>(<c:out value="${innerList.getFirst_air_date()}" />)</p>
        	</div>
...
<div id="pagination">
	<div class="pagination">
	  <a href="<c:out value="?sortBy=${results.getSortBy()}&page=1"></c:out>">&laquo;</a>
	  ...
	  <a  href="<c:out value="?sortBy=${results.getSortBy()}&page=${i}"></c:out>"><c:out value="${i}"></c:out></a>
	  ...
	  <a  href="<c:out value="?sortBy=${results.getSortBy()}&page=${j}"></c:out>"><c:out value="${j}"></c:out></a>
	  </c:forEach>
	  <a href="<c:out value="?sortBy=${results.getSortBy()}&page=${results.getPages()}"></c:out>">&raquo;</a>
	</div>
</div>
</c:if>
<!-- -->
