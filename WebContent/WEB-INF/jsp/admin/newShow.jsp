...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="first_air_date" id="first_air_date">
  </div>
   <div class="form-group">
    <label for="last_air_date">Last air date:</label>
    <input type="text" class="form-control" name="last_air_date" id="last_air_date">
  </div>
     <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="poster_path" id="poster_path" >
  </div>
         <div class="form-group">
    <label for="backdrop_path">Backdrop path:</label>
    <input type="text" class="form-control" name="backdrop_path" id="backdrop_path" >
  </div>
